...
class PermissionSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $permissions = [
            ...
            ['name' => 'Configuración', 'description' => 'Tablas generales', 'icon' => 'settings', 'route' => 'null', 'parent_id' => null, 'order' => 3, 'status' => true],
            ['name' => 'Tiendas', 'description' => 'Registro de Tiendas', 'icon' => 'store', 'route' => '/stores/list', 'parent_id' => 10, 'order' => 0, 'status' => true],
            ['name' => 'Clientes', 'description' => 'Registro de Clientes', 'icon' => 'group', 'route' => '/customers/list', 'parent_id' => 10, 'order' => 1, 'status' => true],
            ['name' => 'Proveedores', 'description' => 'Registro de Proveedores', 'icon' => 'local_shipping', 'route' => '/suppliers/list', 'parent_id' => 10, 'order' => 2, 'status' => true],
            ['name' => 'Productos', 'description' => 'Registro de Productos', 'icon' => 'qr_code', 'route' => '/products/list', 'parent_id' => 10, 'order' => 3, 'status' => true],
            ['name' => 'Marcas', 'description' => 'Registro de Marcas', 'icon' => 'inbox', 'route' => '/brands/list', 'parent_id' => 10, 'order' => 4, 'status' => true],
            ['name' => 'Categorías', 'description' => 'Registro de Categorías', 'icon' => 'category', 'route' => '/categories/list', 'parent_id' => 10, 'order' => 5, 'status' => true],
            ['name' => 'Tipo de Dispositivos', 'description' => 'Registro de Tipo de Disp.', 'icon' => 'devices_wearables', 'route' => '/type-dispositives/list', 'parent_id' => 10, 'order' => 6, 'status' => true],
            ['name' => 'Usuarios', 'description' => 'Registro de Usuarios', 'icon' => 'manage_accounts', 'route' => '/users/list', 'parent_id' => 10, 'order' => 7, 'status' => true],
